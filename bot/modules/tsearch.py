...
DEFAULT_SEARCH_MARKUP = [
                    ...
                    [InlineKeyboardButton("Developer: @akalankanime2", url="https://t.me/akalankanime2")]
                ]


@app.on_message(filters.command("tsearch"))
async def start_handler(_, message: Message):
    try:
        await message.reply_text(
            text="Hello, I am New Module of Mirror & Leech Bot!\n"
                 "I can search Torrent & Magnet Links from Inline.\n\n"
                 "Made by @akalankanime2",
